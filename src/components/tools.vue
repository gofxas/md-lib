<template>
  <div class="app-tools">
    <p class="art-title">标题区域</p>
    <n-space>
      <template v-if="isEdit">
        <n-button type="primary" @click="editCloseHandler" quaternary round>
          <n-icon size="18">
            <svg
        ...
        <n-button @click="editCloseHandler" quaternary round>
          <n-icon size="18">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <n-button type="error" @click="editCloseHandler" quaternary round>
          <n-icon size="18">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
...
export default {
  name: "app-tools",
  components: { NSpace, NButton, NIcon },
  props: {
    isEdit: {
      default: false,
      type: Boolean,
